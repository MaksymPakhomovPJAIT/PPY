...
Original file is located at
    https://colab.research.google.com/drive/1Gy8t6SZqWUJEN1CiwHro8Pu_T-nlWEiV
...
set_intersection = numbers_set.intersection({10, 11, 12})
set_difference = numbers_set.difference({10, 11, 12})
...
with open("output.txt", "w") as file:
    file.write("Student Number: " + "s28215" + "\n\n")
...
with open("output.txt", "r") as file:
    ...
    num_integers = sum([1 for line in content if any(char.isdigit() for char in line)])
    integers_sum = sum([int(num) for line in content for num in line.split() if num.isdigit()])

# Modify File Content
# For example, changing specific lines or adding new lines. Let's add a new line at the end.
...
try:
    ...
    print("Error: Unable to read the largest integer from 'output.txt'.")
    exit(1)
...
with open("prime_numbers.txt", "w") as file:
    ...
    file.write("Is the largest integer prime? " + ("Yes" if largest_integer_is_prime else "No") + "\n")

print("Results written to 'prime_numbers.txt'.")

"""## Results from task 8
Student Number: s28215

Original List: [2, 3, 20, 4, 12, 3, 10]
Original Tuple: (2, 3, 4, 12, 3)
Original Set: {2, 3, 4, 12}
Original Dictionary: {2: 4, 3: 9, 4: 16, 12: 144, 11: 121}

Manipulated List: [2, 3, 20, 4, 12, 3, 10]
Manipulated Tuple: (2, 3, 4, 12, 3)
Union of Set: {2, 3, 4, 10, 11, 12}
Intersection of Set: {12}
Difference of Set: {2, 3, 4}
Updated Dictionary: {2: 4, 3: 9, 4: 16, 12: 144, 11: 121}

List to Tuple: (2, 3, 20, 4, 12, 3, 10)
List to Set: {2, 3, 4, 10, 12, 20}
List to Dictionary: {2: 4, 3: 9, 20: 400, 4: 16, 12: 144, 10: 100}
Tuple to List: [2, 3, 4, 12, 3]
Tuple to Set: {2, 3, 4, 12}
Tuple to Dictionary: {2: 4, 3: 9, 4: 16, 12: 144}
Set to List: [2, 3, 4, 12]
Set to Tuple: (2, 3, 4, 12)
Set to Dictionary: {2: 4, 3: 9, 4: 16, 12: 144}
Dictionary to List: [2, 3, 4, 12, 11]
Dictionary to Tuple: (2, 3, 4, 12, 11)
Dictionary to Set: {2, 3, 4, 11, 12}
...
Is the largest integer prime? No
